...
OUT = RAW / "matches_unified_v2.csv"
...
# The above code is a Python comment. It starts with a `#` symbol, which indicates that the
# following text is a comment and not actual code that will be executed. In this comment, there is
# a note about an old filter "_FS.htm" that used to truncate a lot of data.
# -------------------------
